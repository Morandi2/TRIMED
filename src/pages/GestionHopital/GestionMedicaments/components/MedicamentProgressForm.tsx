...
export const MedicamentProgressForm: React.FC<MedicamentProgressFormProps> = ({
  ...
  const [categories, setCategories] = useState(medicamentService.obtenirCategories(_tenantId));
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 3:
        return !!(formData.prix_achat >= 0 && formData.prix_vente >= formData.prix_achat);
      case 4:
        return true;
      default:
        return true;
