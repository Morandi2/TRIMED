...
import { UserRound, Stethoscope, Asterisk, CalendarPlus2, Calendar, Pill } from 'lucide-react';

export const InfirmierDashboard: React.FC = () => {

  const modules = [
    { name: 'Patients', path: '/patient', icon: <UserRound className="w-8 h-8" />, color: 'bg-blue-500' },
    { name: 'Médecins', path: '/medecin', icon: <Stethoscope className="w-8 h-8" />, color: 'bg-teal-500' },
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Bienvenue Infirmier(e)</h2>
        <p className="text-gray-600 dark:text-gray-400">Consultez les informations patients et suivez les soins</p>
      </div>
