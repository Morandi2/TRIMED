...
export const SearchableSelect: React.FC<SearchableSelectProps> = ({
  ...
  const loadOptions = () => {
    ...
    if (type === 'patient') {
      const patients = consultationService.obtenirPatients();
      ...
      const medecins = consultationService.obtenirMedecins();
      ...
      newOptions = [
        { id: 1, name: 'Salle 101', extra: 'Consultation générale', searchText: 'Salle 101 consultation générale' },
        { id: 2, name: 'Salle 102', extra: 'Consultation spécialisée', searchText: 'Salle 102 consultation spécialisée' },
        { id: 3, name: 'Salle 103', extra: 'Urgences', searchText: 'Salle 103 urgences' }
      ];
    }
