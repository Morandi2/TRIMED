...
export default function TenantPaiementModule({ tenantId, currentPlan = 'enterprise' }: TenantPaiementModuleProps) {
  useEffect(() => {
  ...
  const loadTenantData = () => {
    ...
    const abonnements = abonnementService.obtenirTousAbonnements(tenantId);
